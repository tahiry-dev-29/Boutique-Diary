  ...
  if (items.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-8 text-center space-y-6">
        ...
        <Link
          href="/"
          className="btn-primary text-white px-8 py-3 rounded-xl font-bold transition-all flex items-center gap-2"
        >
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="space-y-4">
            {items.map(item => (
              <div
                key={item.id}
                className="group relative flex gap-6 p-4 sm:p-6 rounded-3xl border border-border/40 bg-card hover:border-border/80 hover:shadow-sm transition-all duration-300"
              >
                {}
                ...
                <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-start gap-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 text-sm text-muted-foreground">
                          {item.size && (
                            <span className="bg-secondary/50 px-2.5 py-1 rounded-lg text-xs font-bold text-foreground">
                              {item.size}
                            </span>
                          )}
                          {item.color && (
                            <span className="flex items-center gap-1.5 bg-secondary/50 px-2.5 py-1 rounded-lg text-xs text-foreground">
                              <span
                  ...
                  <div className="flex justify-between items-end mt-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 text-muted-foreground hover:text-red-500 transition-colors text-sm font-medium px-3 py-2 rounded-xl hover:bg-red-50"
                    >
        ...
        <div className="lg:w-[400px] shrink-0">
          <div className="bg-gray-50 rounded-3xl p-6 sm:p-8 sticky top-24">
            ...
            <Link
              href="/checkout"
              className="w-full btn-primary text-white py-4 rounded-2xl font-bold text-lg transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group"
            >
