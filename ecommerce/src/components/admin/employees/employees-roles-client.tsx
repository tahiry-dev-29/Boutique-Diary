...
const allPermissions: Permission[] = [
  ...
  { id: "categories.manage", label: "Gérer les catégories", icon: Layers },
  ...
  { id: "marketing.manage", label: "Gérer le marketing", icon: Tags },
  { id: "shipping.manage", label: "Gérer la livraison", icon: Truck },
  { id: "payment.manage", label: "Gérer les paiements", icon: CreditCard },
  ...
  { id: "search.view", label: "Utiliser la recherche", icon: Search },
          ...
          return (
            ...
            >
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-900/50 flex items-center justify-between">
                ...
                {role.isEditable && canEdit && !isEditing && (
                  <button
